...
✅ **Skip Functionality**<br>While developing this program, I quickly realized the need for a way to exit loops gracefully, especially when a user selects something incorrect. To address this, I implemented a "skip" function, allowing the user to simply type skip in any input field to return to the start of the program seamlessly.
...
| **Possibility to Skip** | Users can type skip in any input field to return to the start of the program, providing an efficient way to exit loops or correct mistakes. | ![Example](images/example-skip.png)  |
